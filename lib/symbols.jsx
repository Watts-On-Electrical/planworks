  ...
  sockets: {
    ...
    items: [
      ...
      { id: "sock_tv", name: "TV Point", svg: (
        <g fill="none" stroke="currentColor" strokeWidth={1.55} strokeLinecap="round" strokeLinejoin="round">
          <path d="M16 25V14"/><path d="M9 8l7 6 7-6"/><circle cx="16" cy="26.5" r="1.4" fill="currentColor" stroke="none"/>
        </g>
      )},
  ...
  data: {
    ...
    items: [
      { id: "data_point", name: "Data Point (Cat5/6)", svg: (
        <g fill="none" stroke="currentColor" strokeWidth={1.55} strokeLinecap="round" strokeLinejoin="round">
          <rect x="8" y="12" width="16" height="10" rx="2"/><path d="M12 12v-2.5h8V12"/><path d="M12.5 18.5h7"/>
        </g>
      )},
