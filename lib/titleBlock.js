...
export function mergeTitleBlocks(profileBlock, legacyBlock) {
  ...
  //
  // Capped at MAX_TITLE_LOGOS. TitleLogos lays them out flexWrap: nowrap
  // inside maxWidth 380, and at three it drops to 110px each plus 12px gaps,
  // which just fits; a fourth would overflow the panel. Trimmed silently --
